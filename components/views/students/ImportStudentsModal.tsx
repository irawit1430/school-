          ...
          <div className="mb-6">
            ...
            <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg flex items-start gap-3">
              ...
              <div className="text-xs text-amber-800">
                ...
                <p>New parents will receive temporary passwords generated by the system. Older imported parents still have "password123" and should reset their passwords.</p>
              </div>
            </div>
          </div>
